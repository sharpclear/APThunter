...
| `ANTHROPIC_API_KEY` | 仿冒域名检测 LLM 研判 API Key | 空 | 是（运行仿冒检测时） |
| `ANTHROPIC_MODEL` | 仿冒域名检测 LLM 模型 | `claude-opus-4-8` | 否 |
| `ANTHROPIC_API_URL` | Anthropic Messages API 地址 | `https://api.anthropic.com/v1/messages` | 否 |
