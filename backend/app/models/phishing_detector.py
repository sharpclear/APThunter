...
def detect_phishing_domains(
    ...
    参数:
        ...
        similarity_threshold: 相似度阈值（0-1），如果提供则使用该阈值，否则使用自适应阈值
...
def predict_from_domains(
    ...
    # 执行检测，传入阈值
    df, statistics = detect_phishing_domains(official_domains, detection_domains, similarity_threshold)
