...
CREATE TABLE IF NOT EXISTS models (
    ...
    model_category ENUM('malicious','impersonation','dga','history_similarity') NULL,
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    task_type ENUM('malicious','impersonation','malicious_ip','dga','history_similarity') NOT NULL,
...
CREATE TABLE IF NOT EXISTS training_tasks (
    ...
    model_category ENUM('malicious','impersonation','dga','history_similarity') NOT NULL DEFAULT 'malicious',
...
CREATE TABLE IF NOT EXISTS alerts (
    ...
    task_type ENUM('malicious', 'impersonation', 'malicious_ip', 'dga', 'history_similarity') NOT NULL COMMENT '任务类型：恶意域名检测/仿冒域名检测/恶意IP检测/DGA域名检测/历史高度相似检测',
...
CREATE TABLE IF NOT EXISTS alert_files (
    ...
    user_id BIGINT UNSIGNED NOT NULL COMMENT '用户ID',
    model_id BIGINT UNSIGNED NOT NULL COMMENT '模型ID',
    task_type ENUM('malicious', 'impersonation', 'malicious_ip', 'dga', 'history_similarity') NOT NULL COMMENT '任务类型',
