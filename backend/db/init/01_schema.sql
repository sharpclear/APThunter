...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    task_type ENUM('malicious','impersonation','malicious_ip') NOT NULL,
...
CREATE TABLE IF NOT EXISTS alerts (
    ...
    task_type ENUM('malicious', 'impersonation', 'malicious_ip') NOT NULL COMMENT '任务类型：恶意域名检测/仿冒域名检测/恶意IP检测',
...
CREATE TABLE IF NOT EXISTS alert_files (
    ...
    user_id BIGINT UNSIGNED NOT NULL COMMENT '用户ID',
    model_id BIGINT UNSIGNED NOT NULL COMMENT '模型ID',
    task_type ENUM('malicious', 'impersonation', 'malicious_ip') NOT NULL COMMENT '任务类型',
