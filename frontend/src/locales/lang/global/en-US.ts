export default {
  ...
  'menu.detection.step-detection.result': 'Step detection(finished)',
  'menu.detection.mytask': 'Advanced detection',
  'menu.link': 'Link',
  'menu.link.iframe': 'Ant Design',
  'menu.link.antdv': 'Ant Design Vue',
  'menu.link.external': 'BaiDu',
  'menu.menu': 'Menu',
  'menu.menu.menu1': 'Model Training',
  'menu.menu.menu2': 'Model Market',
  'menu.menu.menu3': 'Menu1-1',
  'menu.menu.my-model': 'My Model',
