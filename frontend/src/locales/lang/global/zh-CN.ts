export default {
  ...
  'menu.detection.apt-template-nrd-detection': '模板化APT域名检测',
  ...
  'menu.detection.step-detection.result': '分步表单（完成）',
  'menu.detection.mytask': '我的任务',
  'menu.detection.alert': '订阅与预警',
  'menu.link': '链接',
  'menu.link.iframe': 'AntDesign',
  'menu.link.antdv': 'AntDesignVue',
  'menu.link.external': '跳转百度',
  'menu.models': '模型管理',
  'menu.models.model-training': '模型训练',
  'menu.models.model-market': '模型市场',
  'menu.models.my-model': '我的模型',
  'menu.access': '权限模块',
