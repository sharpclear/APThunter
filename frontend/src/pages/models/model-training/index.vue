...
async function uploadFileToBackend(file: File) {
  ...
  try {
    ...
    const resp = await fetch(`${API_BASE}/api/training/upload-data`, {
      method: 'POST',
...
async function fetchTrainingStatus() {
  ...
  try {
    const resp = await fetch(`${API_BASE}/api/training/tasks/${currentTaskId.value}/status`, {
      method: 'GET',
      headers: buildHeaders(),
    })
...
async function fetchTrainingResult() {
  ...
  try {
    const resp = await fetch(`${API_BASE}/api/training/tasks/${currentTaskId.value}/result`, {
      method: 'GET',
      headers: buildHeaders(),
    })
...
async function handlePause() {
  ...
  try {
    const resp = await fetch(`${API_BASE}/api/training/tasks/${currentTaskId.value}/pause`, {
      method: 'POST',
      headers: buildHeaders(),
    })
...
async function handleResume() {
  ...
  try {
    const resp = await fetch(`${API_BASE}/api/training/tasks/${currentTaskId.value}/resume`, {
      method: 'POST',
      headers: buildHeaders(),
    })
...
async function handleStop() {
  ...
  Modal.confirm({
    ...
    onOk: async () => {
      try {
        const resp = await fetch(`${API_BASE}/api/training/tasks/${currentTaskId.value}/stop`, {
          method: 'POST',
          headers: buildHeaders(),
        })
