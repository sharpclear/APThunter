...
declare global {
  ...
  const STORAGE_USER_ID_KEY: typeof import('../src/composables/user-id')['STORAGE_USER_ID_KEY']
  ...
  const isAuthorizationExpired: typeof import('../src/composables/authorization')['isAuthorizationExpired']
  ...
  const useUserId: typeof import('../src/composables/user-id')['useUserId']
